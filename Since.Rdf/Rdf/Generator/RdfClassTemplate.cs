...
namespace Since.Rdf.Generator
{
    ...
    public partial class RdfClassTemplate : RdfClassTemplateBase
    {
        /// <summary>
	...
	foreach (INode classNode in this.GetClasses())
	{
		...
		if (!String.IsNullOrWhiteSpace(baseIri))
            ...
            this.Write("\t\r\n    [RdfClass(Iri = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(classIri));
            this.Write("\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(baseIriText));
            this.Write(")]\r\n\tpublic partial class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(className));
            this.Write(" : RdfObject\r\n\t{\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(className));
            this.Write("(INode node, IEdgeSet edgeSet = null)\r\n\t\t\t: base(node, edgeSet)\r\n        { }\r\n\r\n");
		...
		foreach (INode propertyNode in this.GetProperties(classNode))
		{
            ...
            this.Write("        [RdfProperty(Iri = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(propertyIri));
            this.Write("\")]\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(propertyType));
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(propertyName));
            this.Write(" { get { return this.GetProperty<");
            this.Write(this.ToStringHelper.ToStringWithCulture(propertyType));
            this.Write(" >(); } set { this.SetProperty(value); } }\r\n\r\n");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "15.0.0.0")]
    public class RdfClassTemplateBase
    {
        #region Fields
